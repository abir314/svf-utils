...
class Scene {
    ...
    getMaterial(id) {
        ...
        const mat = {
            ...
            scale: {
                x: (_d = (_c = (_b = _mat === null || _mat === void 0 ? void 0 : _mat.maps) === null || _b === void 0 ? void 0 : _b.diffuse) === null || _c === void 0 ? void 0 : _c.scale.texture_UScale) !== null && _d !== void 0 ? _d : 1.0,
                y: (_g = (_f = (_e = _mat === null || _mat === void 0 ? void 0 : _mat.maps) === null || _e === void 0 ? void 0 : _e.diffuse) === null || _f === void 0 ? void 0 : _f.scale.texture_VScale) !== null && _g !== void 0 ? _g : 1.0,
            },
        };
...
class Reader {
    constructor(svf, resolve) {
        ...
        zip
            .getEntries()
            .filter((entry) => entry.name !== "manifest.json" && entry.name !== "metadata.json")
            .forEach((entry) => {
    ...
    static async FromDerivativeService(urn, guid, authenticationProvider, host, region) {
        ...
        const accessToken = await authenticationProvider.getToken([
            authentication_1.Scopes.ViewablesRead,
        ]);
        ...
        async function downloadDerivative(urn, derivativeUrn) {
            ...
            const response = await axios_1.default.get(downloadInfo.url, {
    ...
    getMeshPackCount() {
        ...
        this.svf.manifest.assets.forEach((asset) => {
            if (asset.type === SVF.AssetType.PackFile &&
